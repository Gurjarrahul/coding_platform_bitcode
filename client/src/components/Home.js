...
let Home = () => {
    ...
    let [name, setName] = useState('Ramesh Singh');
    let [email, setEmail] = useState('ramesh@gmail.com');
    let [address, setAddress] = useState('India');
    let [college, setCollege] = useState('College Name');
