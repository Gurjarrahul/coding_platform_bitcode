...
// dotenv.config({path:'D:/webdevelopme/react-code-editor/src/config.env'})
...
// const REACT_APP_RAPID_API_KEY='8960b07e5fmsh5ddfdd1bf9f684bp155809jsnb83d3138306b';
const javascriptDefault = `#include<bits/stdc++.h>
using namespace std;
int main(){
  cout<<"Hello World";
  return 0;
